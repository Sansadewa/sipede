                 ...
                 <div class="row">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <?php 
                          if((sizeof($no_sby) == 0)){
                            $kosongan = "<option selected value='0'>Kosongan</option>";
                          }else{
                            $kosongan =  "<option value='0'>Kosongan</option>";
                          }
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tanggal_dibuat" class="form-control tanggal_dibuat" maxlength="18" id="tanggal_akhir" value="<?= $tanggal_dibuat ?>" required="required">
                      </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                     ...
                     <div class="form-group row">
                      ...
                      <div class="form-group">
                            ...
                            <select name="is_pernyataan_tdk_menginap" id="is_pernyataan_tdk_menginap">
                              <option value="0" <?= $is_pernyataan_tdk_menginap == 0?'':'selected' ?> >Tidak</option>
                              <option value="1" <?= $is_pernyataan_tdk_menginap == 1?'selected':'' ?>>Ya</option>
                            </select>
                          </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                      ...
                      <div class="form-group">
                          <div class="col-sm-12">
                              <label class="control-label"> Penginapan dengan Kartu Kredit</label>
                              <input class="form-control" type="number" name="penginapan_cc" id="penginapan_cc" value="<?= $penginapan_cc ?>" />
                            </div>
                      </div>
                      <div class="form-group">
                          <div class="col-sm-12">
                              <label class="control-label"> Transport dengan Kartu Kredit</label>
                              <input class="form-control" type="number" name="transport_cc" id="transport_cc" value="<?= $transport_cc ?>" />
                            </div>
                      </div>
...
<?php if($this->session->flashdata('success')) { ?>
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "<?= base_url('surat_bayar/print_sby?id='.$matriks_kegiatan->id) ?>";
        } 
      })
  <?php } ?>
