          ...
          <div class="col-lg-12">
            <div class="card card-primary">
              <div class="card-header">
                <h4 class="card-title"> Daftar SPPD Disetujui PPK </h4>
...
$(document).ready(function() {
 ...
 function form_print(is_spd,id_matriks){
  if(is_spd == 1){
    window.open("<?= base_url('surat_bayar/print_sby?id=')?>"+id_matriks,'_blank');
  }else{
 ...
 function load_table(n,y){
  ...
  oTable = $('#table_data').DataTable({
        ...
        "ajax": {
          type: "POST",
          url: "<?= base_url('/surat_bayar/get_all_table') ?>",
